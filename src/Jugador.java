...
public void jugar()
{
	...
	if (suerte == 1)
	{
		...
		mensaje = "Has ganado! Festeja con tus panas tus " + fichas + " fichas.";
		
	}else{
		fichas -= apuesta; //fichas = fichas - apuesta;
		mensaje = "Haz perdido pobre iluso! Intentalo de nuevo "+ " tienes" + fichas + " fichas";
	}
	...
	public static void main(String[] args) {
       ...
       Jugador dinner = new Jugador ("Dinner Gonzales","123", 28);
       dinner.comprarFichas(50);
       dinner.jugar();
       dinner.jugar();
       float resultado =  dinner.cambiarTodasFichas();
       System.out.println("A "+ dinner.nombre + " salio con $" + resultado + " del casino de los rusos.");
	}
